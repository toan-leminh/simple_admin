...
$Num = grChk($_POST['Num']);
if(!file_put_contents($Path . $Num .'/m1/' . $file ,"")){ echo "内線[" .$file ."]を代表電番".$Num."00の代表1に追加しました";}
}
if(isset($_POST['user2'])){
$file = substr($_POST['user2'],0,3);
$Num = grChk($_POST['Num']);
if(!file_put_contents($Path . $Num .'/m2/' . $file ,"")){ echo "内線[" .$file ."]を代表電番".$Num."00の代表2に追加しました";}
}
}
if(isset($_GET['FP'])){
$FP = substr($_GET['FP'],0,8);
if(!preg_match('/^[1-9]\/m[1-2]\/[1-9][0-9][0-9]/',$FP)){$FP = "100";}
$file = "/etc/asterisk/cf/main/".$FP;
if(file_exists($file)){
if(unlink($file)){
...
if(isset($_GET['FPon'])){
$file = "/etc/asterisk/cf/main/".grChk($_GET['FPon'])."/mail/on";
if(file_exists($file)){
if(unlink($file)){
...
if(isset($_GET['FPoff'])){
$file = "/etc/asterisk/cf/main/".grChk($_GET['FPoff'])."/mail/on";
...
$mail = "";
$mail2 = "";
if(isset(glob($mailpath)[0])){ $mail = glob($mailpath)[0] ;}
if(!empty($mail)){      //on
